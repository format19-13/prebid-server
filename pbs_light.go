...
func init() {
	...
	viper.SetDefault("adapters.eplanning.endpoint", "http://ads.us.e-planning.net/dsp/obr")
	viper.SetDefault("adapters.rubicon.usersync_url", "http://sync.e-planning.net/um?uid")
